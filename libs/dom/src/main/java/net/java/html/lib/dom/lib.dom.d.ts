...
//XXX    addEventListener(type: "blocked", listener: (ev: Event) => any, useCapture?: boolean): void;
//XXX    addEventListener(type: "error", listener: (ev: ErrorEvent) => any, useCapture?: boolean): void;
//XXX    addEventListener(type: "success", listener: (ev: Event) => any, useCapture?: boolean): void;
//XXX    addEventListener(type: "upgradeneeded", listener: (ev: IDBVersionChangeEvent) => any, useCapture?: boolean): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
}
...
interface XMLHttpRequest extends EventTarget, XMLHttpRequestEventTarget {
    ...
    send(data: Document): void; // XXX use data?
    send(data: string): void; // XXX use data?
    send(data?: any): void;
...
// XXX declare function toString(): string;
